...
public class GrainCommodityAttrController {
     ...
     */
    @GetMapping("/list")
    @PreAuthorize("hasAnyAuthority('sys:grain_commodity_attr:list')")
    ...
    @PreAuthorize("hasAnyAuthority('sys:grain_commodity_attr:save')")
     ...
     */
    @PostMapping("/remove")
    @PreAuthorize("hasAnyAuthority('sys:grain_commodity_attr:remove')")
