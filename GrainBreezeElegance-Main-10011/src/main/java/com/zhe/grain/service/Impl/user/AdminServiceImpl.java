...
import com.zhe.grain.mapper.user.AdminMapper;
...
public class AdminServiceImpl extends ServiceImpl<AdminMapper, AdminEntity>
    ...
    public String adminLogin(AdminLoginVO adminLoginVO, HttpServletRequest request,
        ...
        String phone = adminLoginVO.getUsername();
...
//        CookieUtil.setCookie(request, response, CookieConstant.COOKIE_NAME, ticket);
        ...
        redisCache.setCacheObject(RedisConstant.USER_ENTITY_KEY + ticket, adminByPhone,
    ...
    public AdminEntity getAdminByHeader(String header) {
        ...
        return redisCache.getCacheObject(RedisConstant.USER_ENTITY_KEY + header);
    }
    ...
    public boolean logout(String token) {
        ...
        AdminEntity adminEntity = redisCache.getCacheObject(key);
        if (null == adminEntity) {
            return false;
        }
        return Boolean.TRUE.equals(redisCache.deleteObject(key));
    }
}
